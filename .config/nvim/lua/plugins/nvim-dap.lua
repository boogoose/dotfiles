...
config =function ()
            ...
            -- #############################################################################
            -- PYTHON
            -- print ("I am here PYTHON")
            -- require('dap-python').setup('~/.local/share/nvim/mason/packages/debugpy/venv/bin/python') -- python config is provided by dap-python plugin
            ...
            -- perhaps preferable to move this snippet to dap-ui.lua
            --
-- require("dapui").setup() -- NOTE: strangely this was missing from original config, yet it worked all the same. Adding (modifying 2 lines below) now.
